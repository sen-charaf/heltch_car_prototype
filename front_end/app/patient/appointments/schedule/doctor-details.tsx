      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          <div className="w-full md:w-64 h-64 bg-gray-200 rounded-lg overflow-hidden">
            {doctor.image && doctor.image !== "/placeholder.svg?height=300&width=300" ? (
              <img
                src={doctor.image}
                alt={doctor.name}
              ...
              <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#1e3a8a] to-[#2d4eaa]">
